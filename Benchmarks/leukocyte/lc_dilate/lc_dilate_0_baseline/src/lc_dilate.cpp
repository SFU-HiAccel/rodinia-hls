...
void lc_dilate(float result[GRID_ROWS * GRID_COLS], float img[GRID_ROWS * GRID_COLS])
{
...
void workload(float result[GRID_ROWS * GRID_COLS], float img[GRID_ROWS * GRID_COLS])
{
