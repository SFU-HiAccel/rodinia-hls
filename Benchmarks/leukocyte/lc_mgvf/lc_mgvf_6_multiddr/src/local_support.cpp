...
void run_benchmark( void *vargs, cl_context& context, cl_command_queue& commands, cl_program& program, cl_kernel& kernel ) {
  ...
  cl_mem result_buffer = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_EXT_PTR_XILINX, sizeof(args -> imgvf) , &result_ext, NULL);

  cl_mem_ext_ptr_t imgvf_ext; imgvf_ext.flags = XCL_MEM_DDR_BANK1; imgvf_ext.param = 0; imgvf_ext.obj = 0;
  cl_mem imgvf_buffer   = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_EXT_PTR_XILINX, sizeof(args -> imgvf) , &imgvf_ext, NULL);

  cl_mem_ext_ptr_t I_ext; I_ext.flags = XCL_MEM_DDR_BANK2; I_ext.param = 0; I_ext.obj = 0;
  cl_mem I_buffer  = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_EXT_PTR_XILINX, sizeof(args -> I), &I_ext, NULL);
